...
extern EGLDisplay display_X;
extern EGLSurface surface_X;
...
//export setCurrentContext_X
func setCurrentContext_X(vm *C.JavaVM, ctx C.jobject) {
	mobileinit.SetCurrentContext(unsafe.Pointer(vm), uintptr(ctx))
}

//export callMain_X
func callMain_X(mainPC uintptr) {
...
//export onStart_X
func onStart_X(activity *C.ANativeActivity) {
}

//export onResume_X
func onResume_X(activity *C.ANativeActivity) {
}

//export onSaveInstanceState_X
func onSaveInstanceState_X(activity *C.ANativeActivity, outSize *C.size_t) unsafe.Pointer {
	return nil
}

//export onPause_X
func onPause_X(activity *C.ANativeActivity) {
}

//export onStop_X
func onStop_X(activity *C.ANativeActivity) {
}

//export onCreate_X
func onCreate_X(activity *C.ANativeActivity) {
...
//export onDestroy_X
func onDestroy_X(activity *C.ANativeActivity) {
}

//export onWindowFocusChanged_X
func onWindowFocusChanged_X(activity *C.ANativeActivity, hasFocus C.int) {
}

//export onNativeWindowCreated_X
func onNativeWindowCreated_X(activity *C.ANativeActivity, window *C.ANativeWindow) {
}

//export onNativeWindowRedrawNeeded_X
func onNativeWindowRedrawNeeded_X(activity *C.ANativeActivity, window *C.ANativeWindow) {
...
//export onNativeWindowDestroyed_X
func onNativeWindowDestroyed_X(activity *C.ANativeActivity, window *C.ANativeWindow) {
	windowDestroyed <- window
}

//export onInputQueueCreated_X
func onInputQueueCreated_X(activity *C.ANativeActivity, q *C.AInputQueue) {
	inputQueue <- q
	<-inputQueueDone
}

//export onInputQueueDestroyed_X
func onInputQueueDestroyed_X(activity *C.ANativeActivity, q *C.AInputQueue) {
	inputQueue <- nil
	<-inputQueueDone
}

//export onContentRectChanged_X
func onContentRectChanged_X(activity *C.ANativeActivity, rect *C.ARect) {
}
...
//export onConfigurationChanged_X
func onConfigurationChanged_X(activity *C.ANativeActivity) {
...
// //export onLowMemory_X
// func onLowMemory_X(activity *C.ANativeActivity) {
// }
...
func mainUI(vm, jniEnv, ctx uintptr) error {
	...
	for {
		...
		case w := <-windowRedrawNeeded:
			if C.surface_X == nil {
				if errStr := C.createEGLSurface_X(w); errStr != nil {
		...
		case <-windowDestroyed:
			if C.surface_X != nil {
				if errStr := C.destroyEGLSurface_X(); errStr != nil {
					return fmt.Errorf("%s (%s)", C.GoString(errStr), eglGetError())
				}
			}
			C.surface_X = nil
		...
		case <-theApp.publish:
			...
			if C.surface_X != nil {
				...
				if C.eglSwapBuffers(C.display_X, C.surface_X) == C.EGL_FALSE {
...
func processKey(env *C.JNIEnv, e *C.AInputEvent) {
	...
	k := key.Event{
		Rune: rune(C.getKeyRune_X(env, e)),
